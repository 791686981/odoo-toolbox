...
class DatabaseBackupNode(Base):
    ...
    zip_file_id = Column(String(36), ForeignKey("uploaded_files.id"), nullable=True)
    node_kind = Column(String(50), nullable=False, default="snapshot")
    snapshot_type = Column(String(50), nullable=True)
    domain = Column(String(255), nullable=True)
    requirement_title = Column(String(500), nullable=True)
    notion_url = Column(String(1000), nullable=True)
    base_node_id = Column(String(36), nullable=True)
